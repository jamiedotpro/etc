...
# layer add..
w1_1 = tf.Variable(tf.random_normal([3, 3, 32, 64], stddev=0.01))
print('w1_1: ', w1_1)
#   Conv    -> (
#   Pool    -> (
l1 = tf.nn.conv2d(l1, w1_1, strides=[1, 1, 1, 1], padding='SAME')
print('l1: ', l1)
l1 = tf.nn.relu(l1)

# layer add..
w1_2 = tf.Variable(tf.random_normal([3, 3, 64, 32], stddev=0.01))
print('w1_2: ', w1_2)
#   Conv    -> (
#   Pool    -> (
...
w3_0 = tf.get_variable('w3_0', shape=[7 * 7 * 64, 10],
                        initializer=tf.contrib.layers.xavier_initializer())
b_0 = tf.Variable(tf.random_normal([10]))
l2_flat = tf.matmul(l2_flat, w3_0) + b_0
