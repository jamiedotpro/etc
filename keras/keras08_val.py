...
# train -> 훈련 데이터
# val -> 머신이 validation  (검증단계 하나 더 넣음. train <-> val 반복하고 넘어감)
# test -> 평가 evaluate
# predict -> 예측
...
model.fit(x_train, y_train, epochs=300, batch_size=1, validation_data=(x_val, y_val))   # validation_data 훈련하면서 검증까지 함. 추가하면 훈련이 더 잘됨
