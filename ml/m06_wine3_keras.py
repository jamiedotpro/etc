...
# acc:  0.9285714283281443

model.add(Dense(8, input_shape=(11, ), activation='relu'))
model.add(Dense(16, activation='relu'))
model.add(Dense(8, activation='relu'))
model.add(Dense(1, activation='relu'))
# acc:  0.9295918362481254

# model.add(Dense(4, input_shape=(11, ), activation='relu'))
# model.add(Dense(8, activation='relu'))
# model.add(Dense(4, activation='relu'))
# model.add(Dense(1, activation='relu'))
# acc:  0.92857142808486
...
model.fit(x_train, y_train, epochs=2000, batch_size=15, verbose=1,
